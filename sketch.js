...
function setup() {
	...
	bob1=Bodies.circle(310,400,30,bob_option);
	World.add(world,bob1);

	bob2=Bodies.circle(350,400,30,bob_option);
	World.add(world,bob2);

	bob3=Bodies.circle(390,400,30,bob_option);
	World.add(world,bob3);

	bob4=Bodies.circle(430,400,30,bob_option);
	World.add(world,bob4);

	bob5=Bodies.circle(470,400,30,bob_option);
